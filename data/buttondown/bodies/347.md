...
<buttondown-button href="https://weekly.thingelstad.com/members/?email={{ subscriber.email | urlencode }}">Become a Supporting Member</buttondown-button>
{% endif %}
...
Thank you for helping support the EFF over the last year! 💙

{% elif subscriber.subscriber_type == 'regular' %}

Not yet a supporting member? Now is a great time to start!
...
{% if medium == 'email' %}
<img src="https://tinylytics.app/pixel/a2YQr3ZMqkySNYSwz4uF.gif?path=/email/347/" alt="" style="width:1px;height:1px;border:0;" />
{% endif %}