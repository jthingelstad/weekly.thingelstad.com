...
We stopped midway on Skyline Drive to have lunch at [Alice's Restaurant](http://www.calhsta.org/library/alices.html). It's a little unclear if it is *the* Alice's Restaurant. It does not appear to be "a half-a-mile from the railroad tracks". On their menu they specify that it was created around the same time as the song, and the owner's name was Alice. Good enough for me.
