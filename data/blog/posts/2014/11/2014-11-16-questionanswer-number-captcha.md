...
I decided to apply the same type of [spam defense I've successfully used for MediaWiki](https://www.thingelstad.com/2014/updated-dynamic-questy-captchas/) and early results are great. It uses the [Numbers\_Words](http://pear.php.net/package-info.php?package=Numbers_Words) PHP package to spell out a number of nine digits and then ask the user to identify the number in a specific position. The question looks like this:
