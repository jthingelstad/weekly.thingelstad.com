...
<img src="https://www.thingelstad.com/uploads/2020/212c138a67.jpg" alt="Rocket ship icon on a fiery orange planet background, representing the MarsEdit desktop blogging application logo." style="width: 128px; float: right; margin-left: 10px; " />
...
It's not just doing the editing on the Mac or PC either. MarsEdit is using the editor *you* like for what *you* want to do. For example, I'm doing almost all of my blogging in the distraction free, completely uncluttered environment of [WriteRoom](http://hogbaysoftware.com/products/writeroom). (I'll do a [post on WriteRoom](https://www.thingelstad.com/2007/12/03/stay-focused-in.html) soon too.)
