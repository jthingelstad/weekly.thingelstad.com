...
*Note, the Intel Pro/1000MT supports frame sizes up to 16,000 bytes! However, when I used these [iperf](http://dast.nlanr.net/Projects/Iperf/) kept on crashing on me when I did the test. Note, the SMC 8508T only supports up to 9000 bytes frames so not sure what happens when you try to send frames larger than the switch supports.*
...
The next Geek Fest will be the installation of over a [terabyte of disk in the home server](https://www.thingelstad.com/2004/04/02/project-terabyte.html). Stay tuned!
