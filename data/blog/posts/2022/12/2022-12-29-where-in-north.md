---
microblog_id: 1766447
url: "https://www.thingelstad.com/2022/12/29/where-in-north.html"
title: "Where in North Dakota is Carmen Sandiego?"
published: "2022-12-29T15:57:31+00:00"
post_kind: post
categories: []
---

When I was in high school in Minot, ND I used to volunteer for [Craig Nansen](https://www.linkedin.com/in/cnansen/), the Technical Coordinator for the Minot Public School District. I got connected to Nansen when I got my Apple //c for Christmas and wrote a letter to the Apple User Group of Minot, which was organized by Craig and was defunct. If I remember right I had also written to Apple to get the name of the local user group.

That connection turned into an opportunity to work with him after school which I leapt after to get access to the labs of Apple and Macintosh computers. A lot of what I remember doing was using the special software from [MECC](https://en.wikipedia.org/wiki/MECC) to make hundreds and hundreds of copies of 5.25" [floppy disks](https://en.wikipedia.org/wiki/Floppy_disk) for the various labs.
...
Craig's reply to that tweet was the genesis of what eventually turned into a hunt to fully document this rare title. The journey is chronicled in this [Screenland S1 E6: Eight-bit archaeologists](https://www.redbull.com/us-en/episodes/eight-bit-archaeologists-screenland-s01-e06) episode with [Frank Cifaldi](https://en.wikipedia.org/wiki/Frank_Cifaldi) of the [Video Game History Foundation](https://gamehistory.org). The segments are 5:46 - 10:41, 15:09 - 19:06, and 21:34 - 24:02.
...
Back then I had gotten pretty good at [QuarkXPress](https://en.wikipedia.org/wiki/QuarkXPress) and did some page layout assistance for the Yearbook committee and used it for some personal projects too. I don't recall very well, but I’m guessing that is where the "Page Layout" part came in.

### Additional References

You can [play Where in North Dakota is Carmen Sandiego?](https://archive.org/details/wozaday_Where_in_North_Dakota_is_Carmen_Sandiego) on Internet Archive in an emulator.

I've independently archived the ROM (disk) files for the game. You need to download the [disk images](https://files.thingelstad.com/archive/Where%20in%20North%20Dakota%20is%20Carmen%20Sandiego.zip) and then load them in an [Apple II Emulator](http://www.scullinsteel.com/apple2/).

There is a [full and super detailed writeup on the game](https://gamehistory.org/where-in-north-dakota-is-carmen-sandiego/) by David Craddock at The Video Game History Foundation.

Also see [Why in the world was Carmen Sandiego in North Dakota?](https://www.inforum.com/lifestyle/arts-and-entertainment/why-in-the-world-was-carmen-sandiego-in-north-dakota) from July 2016 in the Fargo Forum.

The Carmen North Dakota committee turned over some disks and other resources to Frank Cifaldi to be housed in the [Strong Museum of Play](https://www.museumofplay.org) in Rochester, NY as a donation of materials. They also have [Doug Carlston](https://en.wikipedia.org/wiki/Doug_Carlston)'s personal archive from [Brøderbund](https://en.wikipedia.org/wiki/Broderbund).
