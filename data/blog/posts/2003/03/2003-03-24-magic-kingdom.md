---
microblog_id: 1076531
url: "https://www.thingelstad.com/2003/03/24/magic-kingdom.html"
title: "Magic Kingdom"
published: "2003-03-24T06:00:00+00:00"
post_kind: post
categories: []
---
...
It was interesting to be here only a month after the [Columbia was lost on re-entry](https://en.wikipedia.org/wiki/Space_Shuttle_Columbia_disaster). Perhaps most touching was the memorial to astronauts that have lost there lives in action and the picture of the Columbia crew in front of it. The memorial was really striking in its directness. The sun wasn't out when we were there so we weren't able to see the way it reflects sunlight through the astronauts name (a fitting memorial for an astronaut in my book), instead they were illuminated with lights.
...
Today (in a short while here) we are going to [Animal Kingdom](https://disneyworld.disney.go.com/destinations/animal-kingdom/) and [EPCOT](https://disneyworld.disney.go.com/destinations/epcot/). I'm really looking forward to both of these, they should be great. (Tammy just woke up and asked my why I've been up all morning, who knows!). I'll see if I can add some more later.
