...
def main() -> int:
    ...
    parser.add_argument("--questions", type=Path, default=REPO / "pipeline/librarian/eval_questions.json")
    parser.add_argument("--responses", type=Path, help="JSON output from eval_librarian_answers.py or another Thingy response run.")
    parser.add_argument("--rubric", type=Path, default=REPO / "pipeline/librarian/eval_rubric.md")
