...
Usage:
  python scripts/convert_legacy.py                # Convert all legacy issues
  python scripts/convert_legacy.py --issue 30     # Convert a single issue
  python scripts/convert_legacy.py --dry-run      # Preview without writing
"""
