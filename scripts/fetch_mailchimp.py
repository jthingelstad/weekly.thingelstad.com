...
Used downstream by scripts/restore_mailchimp_images.py and
scripts/populate_missing_images.py to recover content that was lost
...
EMAILS_JSON = ROOT / "src" / "_data" / "emails.json"
