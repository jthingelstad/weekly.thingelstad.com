...
Usage:
  python scripts/restore_missing_micropost_photos.py --dry-run
  python scripts/restore_missing_micropost_photos.py
"""
...
def main() -> None:
    ...
    if not missing_path.exists():
        print("ERROR: tmp/missing-photos.json not found — run "
              "scripts/audit_missing_micropost_photos.py first", flush=True)
        sys.exit(1)
