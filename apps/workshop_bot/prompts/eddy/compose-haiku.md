...
- If a `## Thesis` block is present above, that's *your own* stated reading of what this issue is about — anchor the haiku on it. The thesis came from the compose-thesis pass; the haiku is the lyrical echo of the same idea, not an independent re-reading.
